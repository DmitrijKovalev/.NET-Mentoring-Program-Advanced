...
using OnlineStore.CatalogService.Infrastructure.IntegrationTests.Common;
using System.Diagnostics.CodeAnalysis;
using Xunit;

namespace OnlineStore.CatalogService.Infrastructure.IntegrationTests.TestsFixture
{
